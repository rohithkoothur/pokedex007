...

                        {
                            normaltype.pokemon.map((name, index) => {
                                return (
                                    ...
                                    <motion.div className={darkMode?"darktestcardtest":"testcardtest"} key={name} whileHover={{scale:1.1}}>
...

                        {
                            fightingtype.pokemon.map((name, index) => {
                                return (
                                    ...
                                    <motion.div className={darkMode?"darktestcardtest":"testcardtest"} key={name} whileHover={{scale:1.1,originX:0}}>
